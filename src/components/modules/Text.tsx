...
const TextModule = ({ content, contentMaxWidth, alignment = 'left', headingFont = 'sans' }: TextModuleProps) => {
    ...
    const components: PortableTextComponents = {
        ...
        types: {
            ...
            spacer: ({ value }) => {
                const size = (value?.size || 'md') as 'xs' | 'sm' | 'md' | 'lg' | 'xl';
                const sizeClassMap = {
                    xs: 'h-4',
                    sm: 'h-8',
                    md: 'h-16',
